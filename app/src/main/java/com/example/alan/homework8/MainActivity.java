...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date = findViewById(R.id.dpkDataPicker);
        date.setOnDateChangedListener(dpkDatePicker_OnDateChanged);
        cal = findViewById(R.id.cldCalendar);
        cal.setOnDateChangeListener(cldCalendar_OnDateChanged);
